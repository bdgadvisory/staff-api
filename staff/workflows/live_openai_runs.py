...
def build_live_executor() -> WorkflowExecutor:
    ...
    return WorkflowExecutor(
        router=router,
        retrieval=RetrievalClient(),  # env STAFF_MEMORY_SERVICE_MODE=http recommended
